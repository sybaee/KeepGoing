...
$table['cols'] = array(
  ...
  array('label' => 'cash flows from operating activities', 'type' => 'number'),
  array('label' => 'cash flows from investing activities', 'type' => 'number'),
  array('label' => 'cash flows from financing activities', 'type' => 'number'),
  array('label' => 'cash flow from foreign currency translation', 'type' => 'number')
);

foreach ($individual as $r) {
  $temp = array();
  ...
  $temp[] = array('v' => (int) $r['cash_flows_from_operating_activities']);
  $temp[] = array('v' => (int) $r['cash_flows_from_investing_activities']);
  $temp[] = array('v' => (int) $r['cash_flows_from_financing_activities']);
  $temp[] = array('v' => (int) $r['cash_flow_from_foreign_currency_translation']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Individual Cash Flow </span>
        <br />
      </h4>
    </div>

...
$table['cols'] = array(
  ...
  array('label' => 'liabilities assets', 'type' => 'number'),
  array('label' => 'non liabilities assets', 'type' => 'number'),
  array('label' => 'total liabilities', 'type' => 'number')
);
...
foreach ($liabilities as $r) {
  ...
  $temp[] = array('v' => (int) $r['liabilities_assets']);
  $temp[] = array('v' => (int) $r['non_liabilities_assets']);
  $temp[] = array('v' => (int) $r['total_liabilities']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Liabilities </span>
        <br />
      </h4>
    </div>

...
$table['cols'] = array(
  ...
  array('label' => 'equity capital', 'type' => 'number'),
  array('label' => 'capital contributed in excess of par', 'type' => 'number'),
  array('label' => 'retained earnings', 'type' => 'number'),
  array('label' => 'other capital item', 'type' => 'number'),
  array('label' => 'total capital', 'type' => 'number'),
  array('label' => 'total capital and liabilities', 'type' => 'number')
);

foreach ($capital as $r) {
  $temp = array();
  ...
  $temp[] = array('v' => (int) $r['equity_capital']);
  $temp[] = array('v' => (int) $r['capital_contributed_in_excess_of_par']);
  $temp[] = array('v' => (int) $r['retained_earnings']);
  $temp[] = array('v' => (int) $r['other_capital_item']);
  $temp[] = array('v' => (int) $r['total_capital']);
  $temp[] = array('v' => (int) $r['total_capital_and_liabilities']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Capital </span>
        <br />
      </h4>
    </div>

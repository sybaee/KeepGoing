...
$table['cols'] = array(
  ...
  array('label' => 'income before income taxes', 'type' => 'number'),
  array('label' => 'income tax expenses', 'type' => 'number'),
  array('label' => 'net income', 'type' => 'number'),
  array('label' => 'earning per share', 'type' => 'number')
);
...
foreach ($net as $r) {
  ...
  $temp[] = array('v' => (int) $r['income_before_income_taxes']);
  $temp[] = array('v' => (int) $r['income_tax_expenses']);
  $temp[] = array('v' => (int) $r['net_income']);
  $temp[] = array('v' => (int) $r['earning_per_share']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Net Profit </span>
        <br />
      </h4>
    </div>

...
$table['cols'] = array(
  ...
  array('label' => 'current assets', 'type' => 'number'),
  array('label' => 'non current assets', 'type' => 'number'),
  array('label' => 'total assets', 'type' => 'number')
...
foreach ($assets as $r) {
  ...
  $temp[] = array('v' => (int) $r['current_assets']);
  $temp[] = array('v' => (int) $r['non_current_assets']);
  $temp[] = array('v' => (int) $r['total_assets']);
  $rows[] = array('c' => $temp);
}
...
<body>
  ...
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Assets </span>
        <br />
      </h4>
    </div>

...
$table['cols'] = array(
  ...
  array('label' => 'net increase cash and cash equivalents', 'type' => 'number'),
  array('label' => 'cash and cash equivalents at beginning of period', 'type' => 'number'),
  array('label' => 'cash and cash equivalents at end of period', 'type' => 'number')
);

foreach ($integrated as $r) {
  $temp = array();
  ...
  $temp[] = array('v' => (int) $r['net_increase_cash_and_cash_equivalents']);
  $temp[] = array('v' => (int) $r['cash_and_cash_equivalents_at_beginning_of_period']);
  $temp[] = array('v' => (int) $r['cash_and_cash_equivalents_at_end_of_period']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Integrated Cash Flow </span>
        <br />
      </h4>
    </div>

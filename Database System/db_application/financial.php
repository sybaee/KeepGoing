...
$table['cols'] = array(
  ...
  array('label' => 'financial income', 'type' => 'number'),
  array('label' => 'financial expenses', 'type' => 'number')
);
...
foreach ($financial as $r) {
  ...
  $temp[] = array('v' => (int) $r['financial_income']);
  $temp[] = array('v' => (int) $r['financial_expenses']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Financial </span>
        <br />
      </h4>
    </div>

...
$table['cols'] = array(
  ...
  array('label' => 'other income', 'type' => 'number'),
  array('label' => 'other expenses', 'type' => 'number')
);
...
foreach ($other as $r) {
  ...
  $temp[] = array('v' => (int) $r['other_income']);
  $temp[] = array('v' => (int) $r['other_expenses']);
  $rows[] = array('c' => $temp);
}
...
<body>
  <body>
    ...
    <div class="container-index" style="text-align: center;">
      <h4>
        <br /> <br />
        <span style="font-size: 1.5em;" color="#000000"> Other </span>
        <br />
      </h4>
    </div>
